...
const sWorkbook = XLSX.readFile(path.join(__dirname, 'in', 'AGRIBALYSE3.1.1_produits alimentaires - synthese.xlsx'))
const synthesisWS = sWorkbook.Sheets[sWorkbook.SheetNames[0]]
...
fs.writeFileSync(path.join(__dirname, 'out','Agribalyse_' + sWorkbook.SheetNames[0]+'.csv'), synthesisCsvString)

console.log('generating steps details CSV')
const eWorkbook = XLSX.readFile(path.join(__dirname, 'in', 'AGRIBALYSE3.1.1_produits alimentaires - detail etapes.xlsx'))
const stepsWS = eWorkbook.Sheets[eWorkbook.SheetNames[0]]
...
fs.writeFileSync(path.join(__dirname, 'out','Agribalyse_' + eWorkbook.SheetNames[0]+'.csv'), stepsCsvString)

console.log('generating ingredients details CSV')
const iWorkbook = XLSX.readFile(path.join(__dirname, 'in', 'AGRIBALYSE3.1.1_produits alimentaires - detail ingredients.xlsx'))
const ingredientsWS = iWorkbook.Sheets[iWorkbook.SheetNames[0]]
...
fs.writeFileSync(path.join(__dirname, 'out','Agribalyse_' + iWorkbook.SheetNames[0]+'.csv'), ingredientsCsvString)
